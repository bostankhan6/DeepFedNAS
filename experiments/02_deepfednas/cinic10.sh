...
python train.py \
    ...
    --wandb_project_name Deepfednas_cinic10_correct \
    --wandb_group "4_Stage_original_Supernet" \
    --wandb_run_name "cached_60_subnets_p1024_g1024_w-fine-grained" \
    --gpu 0 \
    --dataset cinic10 \
    ...
    --efficient_test \
    --weighted_avg_schedule '{"type":"maxnet_cos_all_subnet","num_steps":800,"init":0.9,"final":0.0125}' \
