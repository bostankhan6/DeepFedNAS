...
try:
    ...
    print(f"ERROR: Could not import necessary modules. Please check your PYTHONPATH and make sure "
          f"'entropy_maximizer_with_effectiveness_with_parallelization_with_params_and_latencyv2' "
          f"contains LatencyPredictorMLP, arch_to_feature_vector_and_names, predict_latency.")
...
MODEL_PATHS = [
    "/home/bostan/projects/superfednas/fedml_experiments/standalone/superfednas/trained_models/4-stage_continued_cached_60_subnets_p1024_g1024_w-fine-grained.pt",
]

# Specify which dataset to test on ('cifar10', 'cifar100', 'cinic10')
DATASET_NAME = 'cifar10'
DATA_PATH = "/home/bostan/projects/superfednas/data/cifar10"

# **NEW**: Base directory for all output files
OUTPUT_BASE_DIR = "/home/bostan/projects/superfednas/fedml_experiments/standalone/superfednas/evaluation/latency_prediction/cifar10_result_latency_experiments2" # Changed name for clarity
...
LPM_GPU_MODEL_PATH = "/home/bostan/projects/superfednas/fedml_experiments/standalone/superfednas/evaluation/latency_prediction/datasets_and_predictor_models_corrected_with_values_cuda/lpm_model_and_scaler_cuda_0.pth"
LPM_CPU_MODEL_PATH = "/home/bostan/projects/superfednas/fedml_experiments/standalone/superfednas/evaluation/latency_prediction/datasets_and_predictor_models_cuda_bs-1/lpm_model_and_scaler_cpu.pth" # Ensure this path is correct if TARGET_DEVICE_FOR_SEARCH is 'cpu'
